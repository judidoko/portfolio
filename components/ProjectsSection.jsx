...
const ProjectsSection = () => {
  ...
  return (
    <section id="projects">
      <h2 className="text-center text-4xl font-bold dark:text-white text-dark mt-4 mb-8 md:mb-12">
        My Projects
      </h2>
      <div className="dark:text-white text-dark flex flex-row justify-center items-center gap-2 py-6">
        <ProjectTag
