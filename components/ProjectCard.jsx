...
const ProjectCard = ({ imgUrl, title, description, gitUrl, previewUrl }) => {
  return (
    <>
      ...
      >
        {/* items-center justify-center absolute top-0 left-0 w-full h-full hover:bg-[#181818] bg-opacity-0 hidden hover:flex hover:bg-opacity-80 transition-all duration-500 */}
      </div>
